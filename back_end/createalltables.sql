CREATE TABLE product(pid int NOT NULL AUTO_INCREMENT, upc int, productname varchar(45), exp_date DATE, unit_cost DOUBLE, quantity int, min_threshold int, unit_price double, cid int, PRIMARY KEY(pid));

CREATE TABLE makers(mid int NOT NULL AUTO_INCREMENT, manufacturer varchar(64), Address varchar(64), Phone char(16), Website  varchar(64), PRIMARY KEY(mid));
